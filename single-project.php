							...
							<article class="hentry">
								...
								<main class="article-body">
									<div class="project-features">
										<?php $project_date = get_post_meta(get_the_ID(),'_itstar_project_date',1); ?>
										<?php $project_meta = get_post_meta(get_the_ID(),'_itstar_group_feature'); ?>
										<div class="project-meta">
											<ul class="project-features-list">
												<li >
													<span class="meta-name"><?php echo __('Date ','itstar'); ?></span>
										...
										<?php $project_images = get_post_meta(get_the_ID(),'_itstar_image_list'); ?>
										<ul class="feature-images">
											<?php $counter = 1; ?>
											<?php if(!empty($project_images)){ ?>
												 <?php foreach($project_images[0] as $image_src){?>
														<?php $img_thumb_src = itstar_get_image_src($image_src,'130x130'); ?>													
															<li>
