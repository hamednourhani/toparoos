<?php
	...
	$show_related = get_post_meta(get_the_ID() , '_itstar_related_links');
...
<div class="important-links">
	<section class="layout">
		<div class="virtual-border"> 
			<h4 class="related-links"><?php echo __('related sites','itstar'); ?></h4>
		</div>
	</section>
	<section class="layout">
		<div id="owl-carousel" class="owl-carousel owl-theme">
		  <?php
		  		foreach($related_links as $related_link){ 
					  $link = get_post_meta($related_link->ID,'_itstar_link_url');
